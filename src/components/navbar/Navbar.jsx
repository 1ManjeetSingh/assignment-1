...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="NavBar w-full h-full px-10 py-4 bg-white border border-[#D2D2D2] rounded-tl-[30px] rounded-tr-[30px] rounded-bl-none rounded-br-none backdrop-blur-[220px] inline-flex justify-between items-center hover:cursor-pointer" >
                <div className="logo-container w-[130px] h-[46px] relative w-fit bg-[#FFF]">
                ...
                <div className="SearchBarContainer flex justify-center items-center gap-4 bg-white">
