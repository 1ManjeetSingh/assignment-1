                    ...
                    <div className="Profile self-stretch p-8 bg-white rounded-3xl shadow border border-[#b9b9b9] justify-start items-center gap-6 inline-flex">
                        ...
                        <div className="Heading grow shrink basis-0 self-stretch flex-col justify-center items-start gap-4 inline-flex">
                            ...
                            <div className='flex justify-between'>
                                ...
                                <div className="ButtonsCta h-12 px-9 py-4 bg-[#0071db] rounded-[30px] shadow justify-center max-w-[235px] items-center gap-2 inline-flex">
                                    <div className="ButtonLabel text-center text-white text-lg font-semibold font-['SF UI  Text'] leading-[18px] cursor-pointer">Finalize Candidate</div>
                                </div>
                            </div>
                        </div>
                    </div>
